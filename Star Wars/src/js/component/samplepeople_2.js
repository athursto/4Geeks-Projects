...
export const SamplePerson2 = props => {
			...
			<div className="container">
				<div className="card p-2">
					<div className="row d-flex justify-content-center">
						<h3 className="title text-center">{store.people[params.index].name}</h3>
					</div>
					<div className="row">
					...
					<div className="row">
						<div className="col-sm text-center">
							<p>
								Name:
								<br />
								{store.people[params.index].name}
							</p>
						</div>
						<div className="col-sm border-left text-center">
							<p>
								Height:
								<br /> {store.people[params.index].height}
							</p>
						</div>
						<div className="col-sm border-left text-center">
							<p>
								Gender:
								<br />
								{store.people[params.index].gender}
							</p>
						</div>
						<div className="col-sm border-left text-center">
							<p>
								Hair Color:
								<br />
								{store.people[params.index].hair_color}
							</p>
						</div>
						<div className="col-sm border-left text-center">
							<p>
								Birth Year:
								<br />
								{store.people[params.index].birth_year}
							</p>
						</div>
					</div>
				</div>
